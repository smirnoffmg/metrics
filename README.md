...
**Can you trust that date?** The same forecast, replayed from every Monday of two years of Hibernate with only what Jira showed that day. First it picks how many recent weeks to draw from: over 8 weeks, forecasts from the last 26 weeks scored a 12% lower CRPS than from the last 12, and the last 52 were no better than 26, so the report forecasts from 26. The backlog forecast promises 30 weeks, but 30-week forecasts made a week apart share 29 weeks of outcome, so two years hold just 3 independent ones - too few to judge. The report judges the longest horizon with enough evidence instead: over 8 weeks, 84 of 90 "85% chance" promises came true (12 independent outcomes), cautious rather than optimistic. Kafka, whose throughput halved over the same two years, keeps its forecast on the last 12 weeks and still sees only 52% of 8-week promises come true - the report flags that in red.
